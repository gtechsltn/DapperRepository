...
namespace DapperRepository.Infrastructure;

public class DbHelper
{
    public static void CreateDatabaseAndTables(string serverConnectionString, string defaultConnection, string scriptsFolder)
    {
